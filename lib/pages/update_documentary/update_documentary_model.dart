...
import 'update_documentary_widget.dart' show UpdateDocumentaryWidget;
import 'package:cloud_firestore/cloud_firestore.dart';
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';
import 'package:provider/provider.dart';

class UpdateDocumentaryModel extends FlutterFlowModel<UpdateDocumentaryWidget> {
  ...
  WidgetClassDebugData toWidgetClassDebugData() => WidgetClassDebugData(
        widgetParameters: {
          'documentaryToUpdate': debugSerializeParam(
            widget?.documentaryToUpdate,
            ParamType.Document,
            link:
                'https://app.flutterflow.io/project/b-flix-admin-19wa5o?tab=uiBuilder&page=UpdateDocumentary',
            searchReference:
                'reference=SjgKHQoTZG9jdW1lbnRhcnlUb1VwZGF0ZRIGMDNkNGwwchcIByABKhEKDwoNZG9jdW1lbnRhcmllc1ABWhNkb2N1bWVudGFyeVRvVXBkYXRl',
            name: 'documentaries',
            nullable: true,
          )
        }.withoutNulls,
        ...
        link:
            'https://app.flutterflow.io/project/b-flix-admin-19wa5o/tab=uiBuilder&page=UpdateDocumentary',
        searchReference:
            'reference=OhFVcGRhdGVEb2N1bWVudGFyeVABWhFVcGRhdGVEb2N1bWVudGFyeQ==',
        widgetClassName: 'UpdateDocumentary',
      );
}
