...
const debugRouteLinkMap = {
  ...
  '/show':
      'https://app.flutterflow.io/project/b-flix-admin-19wa5o?tab=uiBuilder&page=show',
  '/profile':
      'https://app.flutterflow.io/project/b-flix-admin-19wa5o?tab=uiBuilder&page=Profile',
  '/updateDocumentary':
      ...
      routes: [
        ...
        FFRoute(
          ...
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'CreatePage')
              : CreatePageWidget(
        ...
        FFRoute(
          ...
          path: '/updateFilms',
          asyncParams: {
            'filmsToUpdate': getDoc(['films'], FilmsRecord.fromSnapshot),
          },
          builder: (context, params) => UpdateFilmsWidget(
            filmsToUpdate: params.getParam(
              'filmsToUpdate',
              ParamType.Document,
            ),
          ),
        ...
        FFRoute(
          ...
          builder: (context, params) =>
              params.isEmpty ? NavBarPage(initialPage: 'show') : ShowWidget(),
        ),
        FFRoute(
          name: 'Profile',
          path: '/profile',
        ...
        FFRoute(
          name: 'UpdateDocumentary',
          path: '/updateDocumentary',
          asyncParams: {
            'documentaryToUpdate':
                getDoc(['documentaries'], DocumentariesRecord.fromSnapshot),
          },
          builder: (context, params) => UpdateDocumentaryWidget(
            documentaryToUpdate: params.getParam(
              'documentaryToUpdate',
              ParamType.Document,
            ),
          ),
